...
export default function Wishlist() {
  ...
  if (items.length === 0) {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center gap-4 px-4 text-center">
        ...
        <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Your wishlist is empty</h1>
        <p className="text-sm text-gray-500 dark:text-slate-400">Tap the heart on any product to save it here.</p>
        <Link
          to="/shop"
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-8 sm:py-14">
      <h1 className="mb-6 text-2xl font-bold text-slate-900 sm:text-3xl dark:text-slate-100">
